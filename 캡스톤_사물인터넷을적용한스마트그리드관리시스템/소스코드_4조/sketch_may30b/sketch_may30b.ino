...
void loop() {
  ...
  ivalue = analogRead(A2);
  ivout = (ivalue * 5.0)/1024.0;
  ivin = ivout/0.2;
  delay(1);
  iAvalue = analogRead(A3);
  iAmps = (iAvalue*5.0)/1024.0;
  iAmps = (iAmps-2.5)*(30/2);
  delay(1);
  ...
  if(Serial.available())
  {
    ...
    else if(cmd =='4') digitalWrite(11,HIGH);
    else if(cmd=='5') digitalWrite(11,LOW);
    else;
  }
  delay(800);
}
